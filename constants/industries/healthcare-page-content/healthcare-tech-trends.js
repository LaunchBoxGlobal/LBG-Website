export const HEALTHCARE_TECH_TRENDS = [
  {
  ...
  },
  {
    ...
    icon: "/industries/healthcare/nlp-in-clinical-documentation-icon.png",
    width: 75,
    height: 79,
  },
  {
    ...
    description:
      "Fascinating AR and VR technologies are enhancing medical training by providing realistic simulations for complex procedures. These tools help professionals refine their skills without any patent risk, by raising care standards and supporting healthcare application development services focused on safety and precision.",
  ...
  },
  {
    ...
    icon: "/industries/healthcare/expansion-of-telepsychiatry-icon.png",
    width: 75,
    height: 79,
  },
  {
    title: "Smart Hospitals with IoT Integration",
    description:
      "IoT-powered smart hospitals connect devices, systems, and data to create efficient care environments. From real-time monitoring to predictive maintenance, IoT reduces operational inefficiencies, automates the staff, and ensures that patients receive timely, accurate, and proactive treatment experiences.",
    icon: "/industries/healthcare/treatment-simulations-icon.png",
    width: 75,
    height: 79,
  },
  {
    title: "Vice Enabled Virtual Health Assistants",
    description:
