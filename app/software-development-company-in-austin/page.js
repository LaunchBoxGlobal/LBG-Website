...
import SoftwareDevelopmentCompanyInAustinPage from "@/components/Locations/pages/SoftwareDevelopmentCompanyinAustin/SoftwareDevelopmentCompanyInAustin";
import Script from "next/script";
import React from "react";

export const metadata = {
  title: "Software Development Company in Austin | LaunchBox Global",
  description:
    "Leading software development company in Austin offering custom solutions for businesses. Mobile apps, web platforms & enterprise systems with proven results.",
  alternates: {
    canonical:
      "https://launchboxglobal.com/software-development-company-in-austin",
  },
};
...
const page = () => {
  return (
    <>
      {/* <Script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Product",
            name: "Software Development Company In Austin",
            image: "",
            description:
              "Top software development company in Austin offering custom solutions for businesses. Mobile apps, web platforms & enterprise systems with proven results.",
            brand: {
              "@type": "Brand",
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 2,
                name: "Software Development Company In Asutin",
                item: "https://launchboxglobal.com/software-development-company-in-austin",
              },
            ],
          }),
        }}
      ...
      <SoftwareDevelopmentCompanyInAustinPage />
    </>
  );
};
