...
function MidpageCTA() {
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center">
          ...
          <div className="md:w-[60%] px-10 md:px-16 py-16 space-y-6">
            ...
            <p className="text-gray-300 text-base md:text-lg leading-relaxed">
              ...
              audience, and stay ahead of competitors without wasting another
              day.
            </p>
  ...
  before:transition before:ease-in-out before:duration-500"
          ...
          {/* Right 3D Marquee */}
          <div className="hidden md:absolute scale-150 md:block md:w-[150%] h-[400px] relative right-0 bottom-16">
