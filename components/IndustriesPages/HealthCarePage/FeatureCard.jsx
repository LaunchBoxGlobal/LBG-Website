...
const FeatureCard = ({ feature }) => {
  return (
    <div className="w-full group border border-[#D3D3D8] rounded-[11px] bg-white relative p-6 min-h-[190px] hover:border-[#F40E00] hover:shadow-[0_10px_15px_1px_#fa928c] transition-all duration-300">
