...
const Timeline = () => {
  return (
    <div className="w-full padding-x">
      <div
        className="w-full flex flex-col lg:flex-row hover:border-blue-600 lg:items-center items-start justify-between 
        ...
        hover:shadow-[0_0_25px_rgba(30,100,200,0.5)]
      ...
      >
        ...
        <div className="flex items-center gap-3">
          <div className="min-w-[66px] h-[66px]  rounded-full flex items-center justify-center">
            <Image
              src="/case-studies/usubz/time.png"
              alt="time-icon"
              width={40}
              height={40}
              priority
        ...
        <div className="flex items-center gap-3">
          <div className="min-w-[66px] h-[66px] fit110-red-bg rounded-full flex items-center justify-center">
            <Image
              src="/case-studies/usubz/globe.png"
              alt="globe-icon"
              width={40}
              height={40}
              priority
        ...
        <div className="flex items-center gap-3">
          <div className="min-w-[66px] h-[66px] fit110-red-bg rounded-full flex items-center justify-center">
            <Image
              src="/case-studies/usubz/user.png"
              alt="user-icon"
              width={44}
              height={40}
              priority
