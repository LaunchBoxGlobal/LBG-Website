...
const Timeline = () => {
  return (
    <div className="w-full padding-x">
      <div
        className="w-full flex flex-col lg:flex-row hover:border-blue-500 lg:items-center items-start justify-between 
      ...
      >
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col items-start gap-1">
            ...
            <p className="text-[18px] lg:text-[20px] font-bold">
              Mobile App, Web App and Software Development 
            </p>
          </div>
        </div>
      </div>
