...
const Output = () => {
  return (
    <section className="w-full overflow-hidden py-40 relative">
      <section className="w-full lg:w-[90%] 2xl:w-[80%] mx-auto relative">
        <Image
        ...
        <div className="flex justify-center relative">
          <Image
            ...
            width={1280}
            height={647}
            className="mx-auto absolute left-1/2 -translate-x-1/2 z-0 top-20"
          />
          <Image
            src={
        ...
        <div className="w-full flex justify-between flex-wrap gap-10 mt-20 z-20">
          <Image
        ...
        <div className="w-full flex justify-between flex-wrap gap-10 mt-20 relative">
          <Image
