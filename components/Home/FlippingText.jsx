...
const FlippingText = ({ phrases }) => {
  ...
  return (
    <div className="relative h-24 md:h-16 lg:h-24 xl:h-32 flex items-start lg:items-center justify-center flex-wrap overflow-hidden font-bold text-center w-[92%] lg:w-[100%] mx-auto mt-2 lg:px-0 leading-10 px-6">
      <div
        ref={wordRef}
      ...
      >
        ...
        {phrases[index]?.split(" ")?.map((word, i) => (
          <span
            key={i}
            className="mr-0 lg:mr-2 red-text text-[9vw] md:text-[5.5vw] break-words"
          >
            {word}
          </span>
        ))}
