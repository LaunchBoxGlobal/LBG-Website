...
const HomeHero = () => {
  return (
    <section className="w-full bg-white relative pt-36 2xl:pt-52 flex flex-col items-center justify-start gap-0 lg:gap-[25px] xl:h-[110vh] overflow-hidden">
      ...
      <Image
        ...
        height={439}
        alt="globe image"
        className="w-[100%] h-[40%] 2xl:h-[45%] absolute -bottom-10 2xl:-bottom-11 shadow-bottom"
      />
      <Image
        src={"/image-glow.png"}
        width={1710}
