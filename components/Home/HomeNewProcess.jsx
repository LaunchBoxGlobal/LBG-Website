  ...
  return (
    <section className="w-full relative">
      ...
      <div className="w-full relative py-20 lg:pb-40">
        <AnimatedLine />
        <div className="absolute bottom-[3%] lg:right-0 midlg:right-[11%] xl:right-[14%] mac:right-[15.3%] midxl:right-[17.5%] 2xl:right-[26.2%] items-center justify-center hidden lg:flex">
          <Image
