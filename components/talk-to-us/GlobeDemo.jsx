...
export function GlobeDemo() {
  ...
  return (
    <div className="flex flex-row items-center justify-center relative w-full">
      <div className="w-full relative overflow-hidden lg:h-[380px] xl:h-[400px] flex justify-center">
        <div className="w-[120vw] h-[120vw] lg:w-[110vw] lg:h-[80vw] z-10 relative lg:top-[-25%] midlg:top-[-33%] xl:top-[-35%]">
