      ...
      <div className="w-full flex flex-col items-center gap-5">
        <AnimatedText>
          <h2 className="section-heading text-center mx-auto">
            Why Choose Our{" "}
            <span className="red-text">Offshore Development</span>
          </h2>
        </AnimatedText>
        <AnimatedText>
          <p className="section-paragraph text-center mx-auto lg:w-[60%]">
            Cut costs by 60%, access global talent, and get 24/7 productivity
            with quality matching in-house teams all with offshore development.
          </p>
        </AnimatedText>
      </div>
