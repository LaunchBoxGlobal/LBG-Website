...
import { OFFSHORE_BENEFITS } from "@/constants/off-shore-development/offshore-benefits";
    ...
    <section className="w-full py-32 xl:py-40 bg-[#F9F9F9] padding-x overflow-hidden">
      <div className="w-full flex flex-col items-center gap-5">
        <h2 className="section-heading text-center mx-auto">
          Why Choose Our <span className="red-text">Offshore Development</span>
        </h2>

        <p className="section-paragraph text-center mx-auto lg:w-[60%]">
          Cut costs by 60%, access global talent, and get 24/7 productivity with
          quality matching in-house teams all with offshore development.
        </p>
      </div>

      <div className="w-full bg-[#F9F9F9] lg:px-16 mt-10 xl:mt-12 hidden lg:flex flex-col items-center mx-auto relative left-[-4.3%]">
        {OFFSHORE_BENEFITS.map((solution, i) => {
