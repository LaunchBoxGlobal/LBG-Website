"use client";
import { OFFSHORE_FAQS } from "@/constants/off-shore-development/offshore-faqs";
...
const OffShoreFaqs = () => {
  ...
  return (
    <section
      className="w-full py-10 lg:pt-20 lg:pb-32 padding-x flex flex-col items-center bg-[#fff]"
      id="faqs"
    >
