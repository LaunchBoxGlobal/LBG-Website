...
const OffShoreProcess = () => {
  return (
    <div className="w-full relative  py-20">
      <AnimatedLine />
      <div className="absolute bottom-[7%] right-[13%] items-center justify-center hidden lg:flex">
        <Image
...
{
  /* <svg width="767" height="1891" viewBox="0 0 767 1891" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M332.5 2.00122H528.5C556 1.8399 611 17.5847 611 81.8546V299.151V360.13H92.0003C49.5003 360.13 2.00028 366.325 2.00028 447.243V742.943H528.5C556 742.297 611 757.365 611 822.796V1090.43H92.0003C53.5003 1090.43 2.00028 1090.43 2.00028 1147.05V1442.26V1648.5C1.99965 1680.5 2.00028 1705.49 2.00028 1765.5V1837.5C2.00185 1870.5 14.5013 1889.46 92.0003 1889.46H528.5H718.002C761.451 1889.46 765.451 1874.5 765.451 1822V1673.5" stroke="#F40E00" stroke-width="2.5"/>
</svg> */
}
