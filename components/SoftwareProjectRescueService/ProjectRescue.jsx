...
import { AI_BASED_PROJECT_BENEFITS } from "@/constants/ai-based-projects-content/ai-based-project-benefits";
    ...
    <section className="w-full py-20 midlg:py-32 xl:py-40 padding-x overflow-hidden">
      <section className="w-full flex flex-col items-center justify-center gap-6 text-center">
        <h2 className="section-heading lg:w-[90%] mx-auto">
          Key Benefits You Receive from Software{" "}
      ...
      <div className="w-full bg-[#fff] lg:px-16 mt-10 xl:mt-12 hidden lg:flex flex-col items-center mx-auto relative left-[-4.3%]">
        {AI_BASED_PROJECT_BENEFITS.map((solution, i) => {
      ...
      <div className="w-full mt-14 bg-[#fff] lg:hidden block">
        {AI_BASED_PROJECT_BENEFITS?.map((solution, i) => {
          return (
            <div
