"use client";
import { STAFF_AUGMENTATION_FAQS } from "@/constants/StaffAugmentation/staff-augmentation-faqs";
  ...
  return (
    ...
    >
      ...
      <section className="w-full mt-10 lg:mt-24 flex flex-col items-start gap-4 lg:w-[90%]">
        {STAFF_AUGMENTATION_FAQS?.map((faq, index) => (
          <AnimatedText>
            <div
...
export default StaffAugmentationFaqs;
