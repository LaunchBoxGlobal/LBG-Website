    ...
    <section className="w-full py-20 midlg:py-32 xl:py-40 bg-[#fff] padding-x overflow-hidden">
      <section className="w-full flex flex-col items-center justify-center gap-6 text-center">
        ...
        <p className="text-2xl md:text-3xl lg:text-[36px] text-gray-500 lg:w-[90%] mx-auto leading-[3] font-normal">
          ...
          solutions. We specialize in mobile, web, and eCommerce development and
          offer customized services that deliver genuine results. As a leading
          name among software development companies in New Jersey, we combine
          local knowledge with a strong focus on quality. Explore our projects
          and insights in our{" "}
          <Link href={"/blogs"} className="red-text">
            blogs
          </Link>{" "}
          to discover how we can confidently improve your business and help you
          achieve your goals.
        </p>
      </section>
    </section>
