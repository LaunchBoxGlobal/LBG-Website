          ...
          <AnimatedText>
            <div className="w-full rounded-[16px] p-8 min-h-[370px] flex flex-col items-start gap-3 group bg-[#f9f9f9]">
              ...
              <p className="text-lg leading-[1.3]">
                Build once, deploy everywhere. We create apps that work
                seamlessly on iOS and Android, saving Houston businesses time
                and development costs. Learn more about our{" "}
                <Link
