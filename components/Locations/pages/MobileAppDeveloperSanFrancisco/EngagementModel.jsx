    ...
    <section className="w-full padding-x pt-10 lg:pt-20 lg:pb-14 relative overflow-hidden">
      <section className="w-full flex flex-col items-center justify-center gap-6 text-center">
        <h2 className="section-heading w-full">
          Flexible Engagement Models for San Francisco{" "}
          <span className="red-text">Businesses</span>
        </h2>
        <p className="section-paragraph lg:w-[85%]">
          We offer three versatile engagement models: staff augmentation,
          on-demand talent, and offshore development. Each is designed to fit
          your project requirements. With expertise in mobile app development in
          San Francisco, our approach ensures adaptability, cost savings, and
          faster execution.
        </p>
      </section>
      ...
      <section className="w-full my-10 lg:mt-16 lg:mb-28 flex flex-col lg:flex-row gap-y-10 items-center justify-center">
        ...
        >
          ...
          <p className="text-base z-10">
            Easily grow your team with skilled professionals through our{" "}
            <Link
            ...
            . We help San Francisco businesses fill expertise gaps quickly and
            efficiently, ensuring flexibility, reduced overhead, and faster
            project delivery without long-term hiring commitments.
          </p>
          <Link
            href="/contact-us"
        ...
        >
          ...
          <p className="text-base z-10">
            Finding the right specialists in San Francisco can be
            time-consuming. Our{" "}
            <Link
            ...
            provides immediate access to experienced professionals, ensuring
            skill, flexibility, and dependable support — all without the
            constraints of traditional hiring.
          </p>
          <Link
            href="/contact-us"
            className={`w-[149px] z-10 h-[46px] py-4 rounded-full flex items-center justify-center font-semibold text-base transition-all duration-300 ${
        ...
        >
          ...
          <p className="text-base z-10">
            ...
            connects San Francisco businesses with global talent to reduce costs
            while maintaining quality. We deliver scalable, reliable solutions
            that combine international expertise with local insight — achieving
            consistent results aligned with your goals.
          </p>
          <Link
            href="/contact-us"
            className={`w-[149px] z-10 h-[46px] py-4 rounded-full flex items-center justify-center font-semibold text-base transition-all duration-300 ${
