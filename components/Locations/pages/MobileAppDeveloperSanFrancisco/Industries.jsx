...
import { MOBILE_APP_DEV_SAN_FRANCISCO_INDUSTRIES } from "@/constants/locations/mobile-app-development-san-francisco/mobile-app-dev-san-francisco-industries";
    ...
    <section className="w-full padding-x pb-10 lg:pt-28 lg:pb-32 relative overflow-hidden">
      <section className="w-full flex flex-col items-center justify-center gap-6 text-center">
        ...
        <p className="section-paragraph lg:w-[80%]">
         As one of the leading app companies in San Francisco, we provide specialized solutions across industries, delivering apps that meet unique business needs while enhancing engagement, performance, and lasting impact.
        </p>
      </section>

      <section className="industries-wrapper w-full mt-10 lg:mt-16 flex flex-wrap gap-2">
        {MOBILE_APP_DEV_SAN_FRANCISCO_INDUSTRIES?.map((industry, index) => (
          <div
