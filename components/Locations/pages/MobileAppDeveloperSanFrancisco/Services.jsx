"use client"
import { MOBILE_APP_DEVELOPMENT_SAN_FRANCISCO_SERVICES } from "@/constants/locations/mobile-app-development-san-francisco/mobile-app-dev-san-francisco-services";
    ...
    <section className="w-full py-20 midlg:pb-28 bg-[#fff] padding-x overflow-hidden">
      <section className="w-full flex flex-col items-center justify-center gap-6 text-center">
        ...
        <p className="section-paragraph lg:w-[90%] mx-auto">
          Our mobile app development in San Francisco covers everything, including strategy, design, development, and support. We develop reliable, user-focused apps customized to your business goals, ensuring long-term success.
        </p>
      </section>

      <section className="w-full flex items-start justify-center flex-wrap mt-14 gap-5 mx-auto">
        {MOBILE_APP_DEVELOPMENT_SAN_FRANCISCO_SERVICES?.slice(0, 2)?.map((s, i) => {
          return (
        ...
        {MOBILE_APP_DEVELOPMENT_SAN_FRANCISCO_SERVICES?.slice(2, 6)?.map((s, i) => {
          return (
            <div className="w-full md:w-[45%] lg:w-[32%] min-h-[320px]">
              <div
                className="w-full rounded-[16px] p-8 min-h-[390px] flex flex-col items-start gap-3 group bg-[#f9f9f9]"
