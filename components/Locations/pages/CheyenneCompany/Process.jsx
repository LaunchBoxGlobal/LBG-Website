      ...
      <section className="w-full flex flex-col items-center justify-center gap-6 text-center">
        ...
        <AnimatedText>
          <p className="section-paragraph lg:w-[90%] mx-auto">
            We don't do cookie-cutter solutions. Whether you're a mom-and-pop
            shop in Cheyenne or a growing enterprise across Wyoming, we listen
            first - then build a marketing plan that actually works for your
            business. Here's how we adapt:
          </p>
        </AnimatedText>
      </section>
