      ...
      <section className="w-full flex flex-col items-center justify-center gap-6 text-center">
        ...
        <AnimatedText>
          <p className="text-2xl md:text-3xl lg:text-[36px] text-gray-500 lg:w-[90%] mx-auto leading-[3] font-normal">
            ...
            insights to see our expertise in action. In the fast-paced
            environment of web development companies in New Jersey, we stand out
            through our commitment to clear communication, honesty, and
            delivering outcomes that are enduring and aligned with your business
            priorities.
          </p>
        </AnimatedText>
      </section>
