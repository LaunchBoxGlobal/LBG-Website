...
import { MOBILE_APP_DEVELOPMENT_ATLANTA_SERVICES } from "@/constants/locations/mobile-app-development-atlanta/mobile-app-dev-atlanta-services";
...
const Services = () => {
  return (
    <section className="w-full py-20 midlg:pb-28 bg-[#fff] padding-x overflow-hidden">
      <section className="w-full flex flex-col items-center justify-center gap-6 text-center">
        <h2 className="section-heading lg:w-[90%] mx-auto">
          Expert Services in Mobile App Development Atlanta {" "}
          <span className="red-text">Businesses</span>
        </h2>

        <p className="section-paragraph lg:w-[90%] mx-auto">
          Looking for an app developer Atlanta? Our team works side by side with startups to create smart, reliable, user-friendly apps that help startups and businesses grow, engage customers, and stay ahead in today’s digital market.
        </p>
      </section>

      <section className="w-full flex items-start justify-center flex-wrap mt-14 gap-5 mx-auto">
        {MOBILE_APP_DEVELOPMENT_ATLANTA_SERVICES?.slice(0, 2)?.map((s, i) => {
          return (
        ...
        {MOBILE_APP_DEVELOPMENT_ATLANTA_SERVICES?.slice(2, 6)?.map((s, i) => {
          return (
            <div className="w-full md:w-[45%] lg:w-[32%] min-h-[320px]">
              <div
                className="w-full rounded-[16px] p-8 min-h-[390px] flex flex-col items-start gap-3 group bg-[#f9f9f9]"
