...
import { MOBILE_APP_DEV_ATLANTA_FAQS } from "@/constants/locations/mobile-app-development-atlanta/mobile-app-dev-atlanta-faqs";
  ...
  return (
    ...
    >
      ...
      <section className="w-full mt-10 lg:mt-24 flex flex-col items-start gap-4 lg:w-[90%]">
        {MOBILE_APP_DEV_ATLANTA_FAQS?.map((faq, index) => (
          <div
        ...
        >
          <button
            onClick={() => toggleFaq(MOBILE_APP_DEV_ATLANTA_FAQS?.length)}
            className="w-full text-start flex items-start justify-between outline-none"
          >
            <h5 className="font-medium text-[17px] md:text-2xl lg:text-[35px] 2xl:text-[40px] w-[90%]">
              <span className="w-full leading-7 lg:leading-10">
            ...
            <img
              ...
              alt="arrow icon"
              className={`${
                openFaq === MOBILE_APP_DEV_ATLANTA_FAQS?.length
                  ? "scale-y-[-1]"
                  : "scale-y-[1]"
              } transition-all duration-700 w-[18px] h-[18px] lg:w-[24px] lg:h-[26px] lg:mt-3`}
            />
          ...
          <motion.div
            ...
            animate={{
              height:
                openFaq === MOBILE_APP_DEV_ATLANTA_FAQS?.length ? "auto" : 0,
              opacity: openFaq === MOBILE_APP_DEV_ATLANTA_FAQS?.length ? 1 : 0,
              marginTop:
                openFaq === MOBILE_APP_DEV_ATLANTA_FAQS?.length ? "18px" : 0,
            }}
            transition={{ duration: 0.5, ease: "easeInOut" }}
            className="overflow-hidden"
          >
        ...
        >
          <button
            onClick={() => toggleFaq(MOBILE_APP_DEV_ATLANTA_FAQS?.length + 1)}
            className="w-full text-start flex items-start justify-between outline-none"
          >
            <h5 className="font-medium text-[17px] md:text-2xl lg:text-[35px] 2xl:text-[40px] w-[90%]">
              <span className="w-full leading-7 lg:leading-10">
            ...
            <img
              ...
              alt="arrow icon"
              className={`${
                openFaq === MOBILE_APP_DEV_ATLANTA_FAQS?.length + 1
                  ? "scale-y-[-1]"
                  : "scale-y-[1]"
              } transition-all duration-700 w-[18px] h-[18px] lg:w-[24px] lg:h-[26px] lg:mt-3`}
            />
          ...
          <motion.div
            ...
            animate={{
              height:
                openFaq === MOBILE_APP_DEV_ATLANTA_FAQS?.length + 1 ? "auto" : 0,
              opacity:
                openFaq === MOBILE_APP_DEV_ATLANTA_FAQS?.length + 1 ? 1 : 0,
              marginTop:
                openFaq === MOBILE_APP_DEV_ATLANTA_FAQS?.length + 1 ? "18px" : 0,
            }}
            transition={{ duration: 0.5, ease: "easeInOut" }}
            className="overflow-hidden"
          >
        ...
        >
          <button
            onClick={() => toggleFaq(MOBILE_APP_DEV_ATLANTA_FAQS?.length + 2)}
            className="w-full text-start flex items-start justify-between outline-none"
          >
            <h5 className="font-medium text-[17px] md:text-2xl lg:text-[35px] 2xl:text-[40px] w-[90%]">
              <span className="w-full leading-7 lg:leading-10">
            ...
            <img
              ...
              alt="arrow icon"
              className={`${
                openFaq === MOBILE_APP_DEV_ATLANTA_FAQS?.length + 2
                  ? "scale-y-[-1]"
                  : "scale-y-[1]"
              } transition-all duration-700 w-[18px] h-[18px] lg:w-[24px] lg:h-[26px] lg:mt-3`}
            />
          ...
          <motion.div
            ...
            animate={{
              height:
                openFaq === MOBILE_APP_DEV_ATLANTA_FAQS?.length + 2 ? "auto" : 0,
              opacity:
                openFaq === MOBILE_APP_DEV_ATLANTA_FAQS?.length + 2 ? 1 : 0,
              marginTop:
                openFaq === MOBILE_APP_DEV_ATLANTA_FAQS?.length + 2 ? "18px" : 0,
            }}
            transition={{ duration: 0.5, ease: "easeInOut" }}
            className="overflow-hidden"
          >
