    ...
    <section className="w-full py-20 midlg:py-32 bg-white">
      <section className="w-full flex flex-col items-center justify-center gap-6 padding-x text-center">
        ...
        <p className="section-paragraph lg:w-[85%] mx-auto">
          North America held <strong>34.8%</strong> of the mobile application
          development platform market in 2024. By 2025, the market reached{" "}
          <strong>USD 243.55 billion</strong>, and forecasts suggest it could
          hit <strong>USD 480.58 billion by 2030</strong>, growing at a{" "}
          <strong>14.56% CAGR</strong>, reflecting strong global opportunities.{" "}
          <span className="text-gray-500">
            (Source:{" "}
            <a
              className="underline text-[#f40e00]"
              href="https://www.mordorintelligence.com/industry-reports/mobile-application-development-plaform-market"
              target="_blank"
        ...
        <div className="mt-4 flex flex-col items-center justify-center">
          ...
          <p className="mt-3 text-[#F40E00] text-sm w-full text-center">
            Act now and tap huge growth opportunities, reach new audiences, and
            secure a competitive edge in a booming industry.
          </p>
        </div>
      </section>
    </section>
