      ...
      <section className="w-full flex flex-col items-center justify-center gap-6 text-center">
        ...
        <AnimatedText>
          <p className="text-2xl md:text-3xl lg:text-[36px] text-gray-500 lg:w-[90%] mx-auto leading-[3] font-normal">
            ...
            <Link href={`digital marketing`}></Link> and software development
            partner helping Wyoming businesses succeed online. While we serve as
            one of the leading software companies in Houston, we specialize in
            helping Wyoming clients build revenue-generating digital products
            from custom websites to eCommerce platforms all optimized for local
            markets. Our agile approach combines data-driven marketing with
