...
const LocationIndustries = ({ industries }) => {
  return (
    <section className="industries-wrapper w-full mt-10 lg:mt-16 flex flex-wrap gap-2">
      {industries?.map((industry, index) => (
        <div
          className="industry-card h-[300px] md:h-[270px] midlg:h-[340px] xl:h-[250px] bg-[#F3F3F3] p-5 lg:p-8 rounded-[7px] flex flex-col justify-between group relative overflow-hidden md:w-[46%] lg:w-auto"
          key={index}
        >
