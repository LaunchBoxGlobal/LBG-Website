...
import { BRANDING_DESIGN_BENEFITS } from "@/constants/branding-and-design/branding-design-benefits";
    ...
    <section className="w-full py-10 lg:py-20 padding-x">
      <div className="w-full flex flex-col items-center gap-5">
        <h2 className="section-heading text-center">
          Why Design and
          <span className="red-text"> Branding Matter</span>
        </h2>
        <p className="section-paragraph text-center mx-auto lg:w-[90%]">
          Strong branding and design create recognition and trust that lasts.
          Along with customized solutions, we also offer corporate branding
          services to help businesses build identities that inspire loyalty and
          stand out in every market.
        </p>
      </div>

      <div className="w-full bg-white lg:px-16 mt-10 hidden lg:flex flex-col items-center mx-auto relative left-[-4.3%]">
        {BRANDING_DESIGN_BENEFITS.map((solution, i) => {
