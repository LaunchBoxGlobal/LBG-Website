import { BRANDING_AND_DESIGN_FOR_EVERY_BUSINESS } from "@/constants/branding-and-design/branding-and-design-for-every-business";
import React from "react";

const BrandingAndDesignForBusinesses = () => {
  return (
    <section className="w-full padding-x py-10 lg:py-20 relative overflow-hidden">
      <section className="w-full flex flex-col items-center justify-center gap-6 text-center">
        <h2 className="section-heading w-full">
          Design and Branding Services For{" "}
        ...
        <p className="section-paragraph lg:w-[85%]">
          <strong className="font-normal">
            ...
            don’t have to do it all alone. Our design and branding services help
            you create a brand identity customized for growth. Need custom
            visuals or features? Our expertise ensures your brand performs
            flawlessly.
          </strong>
        </p>
      </section>
      ...
      <section className="w-full mt-10">
        <div className="w-full flex flex-col items-center">
          ...
          <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {BRANDING_AND_DESIGN_FOR_EVERY_BUSINESS?.map((b, i) => {
              return (
                <div
...
export default BrandingAndDesignForBusinesses;
