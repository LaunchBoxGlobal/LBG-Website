...
import { KOTLIN_APP_BENEFITS } from "@/constants/kotlin-app-development-content/KotlinBenefits";

const BenefitsSection = ({}) => {
  return (
    <section className="w-full py-10 lg:py-20 padding-x">
      <div className="w-full flex flex-col items-center gap-5">
        {/* <p className="text-2xl font-semibold" style={{ color }}></p> */}
        <h2 className="section-heading text-center">
          The Smarter <span className="kotlin-text">Development Choice</span>
        </h2>
        <p className="section-paragraph text-center mx-auto lg:w-[90%]">
          We build Android apps using Kotlin with Jetpack Compose for screens,
          Coroutines for tasks, and Ktor for connections. These keep the code
          organized and make apps work well on all devices.
        </p>
      </div>

      <div className="w-full bg-white lg:px-16 mt-10 xl:mt-12 hidden lg:flex flex-col items-center mx-auto relative left-[-4.3%]">
        {KOTLIN_APP_BENEFITS?.map((solution, i) => {
