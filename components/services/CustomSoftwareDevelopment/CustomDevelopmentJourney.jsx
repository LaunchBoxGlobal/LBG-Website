        ...
        {PARTNET_WITH_US.map((plan, i) => {
          ...
          return (
            <div
              ...
              className={`w-[90%] lg:w-[400px] h-[480px] rounded-[14px] custom-shadow flex flex-col items-center justify-center gap-6 group text-center p-10 relative transition-all duration-300 hover:scale-110 overflow-hidden ${
                i === 0
            ...
            >
              <Image
                src={"/custom-software-journey-card-texture-image.png"}
