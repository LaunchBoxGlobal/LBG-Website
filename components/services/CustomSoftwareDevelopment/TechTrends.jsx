import { CUSTOM_SOFTWARE_TECH_TRENDS } from "@/constants/custom-software-development/custom-software-tech-trends";
import { TECH_TRENDS } from "@/constants/web-app-dvelopment/tech-trends";
  ...
  return (
    <section className="w-full padding-x py-10 lg:py-20 relative overflow-hidden">
      ...
      <section className="w-full grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 midlg:grid-cols-5 gap-7 mt-10 lg:mt-16">
        {CUSTOM_SOFTWARE_TECH_TRENDS?.map((t, i) => {
