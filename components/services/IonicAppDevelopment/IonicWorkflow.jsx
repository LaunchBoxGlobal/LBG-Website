...
const ProcessCard = ({ process, index }) => {
  return (
    ...
    >
      <h3 className="font-medium text-[26px] lg:text-[39px] text-[#478AFF] leading-[1]">
        {process?.title}
      </h3>
      ...
      >
        <div className="w-full h-full bg-[#478AFF] rounded-full flex items-center justify-center">
          <Image
            src={process?.icon}
            alt={process?.title}
