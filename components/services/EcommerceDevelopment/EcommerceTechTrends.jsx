import { ECOMMERCE_TECH_TRENDS } from "@/constants/ecommerce-develpment/ecommerce-tech-trends";
import React from "react";

const EcommerceTechTrends = () => {
  return (
    <section className="w-full padding-x py-10 lg:py-20 relative overflow-hidden">
      <section className="w-full flex flex-col items-center justify-center gap-6 text-center">
        <h2 className="section-heading w-full lg:w-[70%]">
          Emerging Trends in <span className="red-text">Ecommerce</span>
        </h2>
      </section>

      <section className="w-full grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 midlg:grid-cols-5 gap-7 mt-10 lg:mt-16">
        {ECOMMERCE_TECH_TRENDS?.map((t, i) => {
...
export default EcommerceTechTrends;
...
export const TechTrendsCard = ({ tech }) => {
  return (
    <div className="w-full relative group">
      ...
      <div className="w-full h-[190px] bg-[#F3F3F3] rounded-xl flex flex-col items-center justify-center gap-5 z-10 relative px-5">
