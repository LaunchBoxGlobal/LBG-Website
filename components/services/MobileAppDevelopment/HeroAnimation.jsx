...
const HeroAnimation = () => {
  return (
    <div className="w-full h-[300px] md:h-[496px] lg:h-[596px] relative flex items-center justify-center overflow-visible">
      ...
      {/* lg:-bottom-[29%] xl:-bottom-[34%] */}
      <div className="lg:w-[1000px] lg:h-[1000px] xl:w-[1290px] xl:h-[1290px] rounded-full border-[6px] border-gray-100 absolute bottom-0 left-1/2 -translate-x-1/2 hidden lg:block">
        {/* firebase icon animate-spin-slower*/}
        <div className="absolute inset-0 animate-spin-slower-1">
