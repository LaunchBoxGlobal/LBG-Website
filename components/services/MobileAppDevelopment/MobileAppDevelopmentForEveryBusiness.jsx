...
import { MOBILE_APP_DEVELOPMENT_FOR_EVERY_BUSINESS } from "@/constants/mobile-app-development/mobile-app-development-for-every-business";
import React from "react";

const MobileAppDevelopmentForEveryBusiness = () => {
  return (
    <section className="w-full padding-x py-10 lg:py-20 relative overflow-hidden">
      <section className="w-full flex flex-col items-center justify-center gap-6 text-center">
        ...
        <p className="section-paragraph lg:w-[85%]">
          ...
          have to do it all alone. Our mobile app development services help you
          build scalable mobile applications that grow with you. Need smooth
          integrations? We’ve got you covered. Let’s keep things simple and move
          on to how we make it happen.
        </p>
      </section>
      ...
      <section className="w-full mt-10">
        <div className="w-full flex flex-col items-center">
          ...
          <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {MOBILE_APP_DEVELOPMENT_FOR_EVERY_BUSINESS?.map((b, i) => {
              return (
                <div
...
export default MobileAppDevelopmentForEveryBusiness;
