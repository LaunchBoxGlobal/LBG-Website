...
import { GENERIC_SOLUTIONS } from "@/constants/flutter-app-development/generic-solution";

const GenericSolution = () => {
  return (
    <section className="w-full py-10 lg:py-20 padding-x">
      <div className="w-full flex flex-col items-center gap-5">
        {/* <p className="blueText text-2xl font-semibold">
          Break Free from Generic Software
        </p> */}
        <h2 className="section-heading text-center">
          Why Flutter Works Best for <br className="hidden lg:block" />{" "}
          <span className="blueText">Your App?</span>
        </h2>
        <p className="section-paragraph text-center mx-auto lg:w-[90%]">
          Flutter lets you build beautiful, fast apps for both iOS and Android
          with one codebase. Save time and money while getting a polished,
          native-like experience. As a top Flutter app development company in
          the USA, we create apps that launch quicker, run smoother, and keep
          users happy. No messy coding, just great results that grow your
          business.
        </p>
      </div>

      <div className="w-full bg-white lg:px-16 mt-10 xl:mt-12 hidden lg:flex flex-col items-center mx-auto relative left-[-4.3%]">
        {GENERIC_SOLUTIONS.map((solution, i) => {
