    ...
    <section className="w-full padding-x py-10 lg:py-20 relative overflow-hidden">
      ...
      <section className="w-full flex flex-col items-center justify-center gap-6 text-center">
        <h2 className="section-heading">
          Flutter Apps for Every{" "}
          <span className="blueText"> Every Industry</span>
        </h2>
        <p className="section-paragraph lg:w-[93%]">
          From healthcare to retail, Flutter works where you do. As a leading
          Flutter app development company in the USA, we build custom apps that
          fit your industry's needs whether it's booking appointments faster,
          boosting sales, or simplifying workflows. Let’s create something that
        ...
        >
          {IFLUTTER_NDUSTRIES?.map((value, index) => {
            ...
            return (
              ...
              >
                <div
                  className="w-full rounded-xl p-6 bg-white min-h-[360px] border flex flex-col items-start justify-start gap-3 group hover:bg-[#5290f1] hover:text-white transition-all duration-300"
  ...
  return (
    <section className="w-full flex items-center justify-center gap-3 lg:gap-1 absolute bottom-0 left-0 z-40">
      ...
      <button
        ...
        className="w-[40px] h-[40px] lg:w-[59px] lg:h-[59px] bg-[#5290f1] flex items-center justify-center rounded-full"
      >
