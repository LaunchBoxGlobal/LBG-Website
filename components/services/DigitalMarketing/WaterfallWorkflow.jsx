  ...
  return (
    <section className="w-full mt-10 lg:mt-20 lg:mb-10 relative">
      <Image
        ...
        height={1414}
        loading="lazy"
        className="lg:h-[1500px] midlg:h-[1500px] absolute left-1/2 -translate-x-1/2 lg:top-10 hidden lg:block"
      />
      <Image
      ...
      {workflow?.map((plan, index) => {
        ...
        return (
          ...
          >
            ...
            <h3 className="font-medium text-[22px] md:text-[30px] red-text xl:leading-7">
              {plan?.title}
            </h3>
            <p className="text-[16px] md:text-lg leading-5">
              {plan?.description}
            </p>
            <div
