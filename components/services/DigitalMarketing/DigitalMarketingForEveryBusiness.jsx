...
import { DIGITAL_MARKETING_FOR_EVERY_BUSINESS } from "@/constants/digital-marketing/digital-marketing-for-every-business";
import { WEB_APPS_FOR_BUSINESS } from "@/constants/web-app-dvelopment/web-apps-for-business";
import React from "react";

const DigitalMarketingForEveryBusiness = () => {
  return (
    <section className="w-full padding-x py-10 lg:py-20 relative overflow-hidden">
      <section className="w-full flex flex-col items-center justify-center gap-6 text-center">
        ...
        <p className="section-paragraph lg:w-[85%]">
          ...
          have to do it all alone. Our digital marketing services for small
          businesses help you grow your brand effectively. Need comprehensive
          support? Our full digital marketing services ensure every campaign
          performs flawlessly and drives measurable results.
        </p>
      </section>
      ...
      <section className="w-full mt-10">
        <div className="w-full flex flex-col items-center">
          ...
          <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {DIGITAL_MARKETING_FOR_EVERY_BUSINESS?.map((b, i) => {
              return (
                <div
...
export default DigitalMarketingForEveryBusiness;
