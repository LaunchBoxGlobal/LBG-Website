...
import { REACT_NATIVE_BENEFITS } from "@/constants/react-native-app-development-services/react-native-benefits";
    ...
    <section className="w-full py-10 lg:py-20 padding-x">
      <div className="w-full flex flex-col items-center gap-5">
        ...
        <h2 className="section-heading text-center">
          Why Choose Native Apps for Your{" "}
          <span className="blueText">Business?</span>
        </h2>
        <p className="section-paragraph text-center mx-auto lg:w-[90%]">
          Native apps just work better. They're faster, smoother, and feel like
          they belong on your phone. They use all your device's features like
          the camera, GPS, and notifications. Want an app people love to use?
          Native development makes it happen.
        </p>
      </div>

      <div className="w-full bg-white lg:px-16 mt-10 xl:mt-12 hidden lg:flex flex-col items-center mx-auto relative left-[-4.3%]">
        {REACT_NATIVE_BENEFITS.map((solution, i) => {
