"use client";
import { REACT_NATIVE_FAQS } from "@/constants/react-native-app-development-services/react-native-faqs";
...
const FAQS = () => {
  ...
  return (
    <section
      className="w-full py-10 lg:pt-y0 lg:pb-32 padding-x flex flex-col items-center"
      id="faqs"
    >
      <h2 className="section-heading text-center">
        Got Questions? <br /> We've got You{" "}
        <span className="blueText">Covered!</span>
      </h2>

      <section className="w-full mt-10 lg:mt-24 flex flex-col items-start gap-4 lg:w-[90%]">
        {REACT_NATIVE_FAQS?.map((faq, index) => (
          <div
