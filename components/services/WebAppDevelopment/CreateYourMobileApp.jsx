  ...
  return (
    ...
    >
      <section className="w-full h-[410px] rounded-lg bg-[#212121] relative group overflow-visible z-10">
        <section className="h-full text-white z-20 flex flex-col items-center text-center lg:items-start lg:text-start justify-center gap-5 w-full lg:w-[65%] px-4 lg:px-16 overflow-hidden relative">
          <Image
