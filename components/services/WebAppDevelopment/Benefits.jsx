...
import BenefitsTable from "../MobileAppDevelopment/BenefitsTable";
import BenefitsMobileVersion from "../MobileAppDevelopment/BenefitsMobileVersion";
  ...
  return (
    <section className="w-full padding-x py-10 lg:py-20 relative overflow-hidden">
      ...
      {/* <section className="w-full mt-10 lg:mt-20 border-black flex items-start gap-0">
        <div className="w-[70%] xl:w-[40%] flex flex-col items-start">
            ...
            return (
              <div
                ...
                className={`bg-white px-4 w-[110px] lg:w-[219px]  shadow z-10 border-none relative ${
                  i === 13 ? "rounded-b-2xl h-[70px]" : "h-[80px]"
                }`}
              >
                {i !== 13 && (
        ...
        <div className="w-full lg:w-[15%] hidden xl:flex flex-col justify-start items-center">
