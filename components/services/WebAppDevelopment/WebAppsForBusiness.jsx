...
const WebAppsForBusiness = () => {
  return (
    <section className="w-full padding-x py-10 lg:py-20 relative overflow-hidden">
      <section className="w-full flex flex-col items-center justify-center gap-6 text-center">
        <h2 className="section-heading w-full">
          Web Apps For <span className="red-text">Every Business</span>
        </h2>
        <p className="section-paragraph lg:w-[85%]">
          Running a startup, small business, or even a big enterprise? You don’t
          have to do it all alone. Our web app development services help you
          build scalable web applications that grow with you. Need smooth
          integrations? We’ve got you covered with powerful web APIs. Let’s keep
          things simple and move on to how we make it happen.
        </p>
      </section>
      ...
      <section className="w-full mt-10">
        <div className="w-full flex flex-col items-center">
          ...
          <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {WEB_APPS_FOR_BUSINESS?.map((b, i) => {
              return (
                <div
                  className="w-full bg-[#F6F6F6] p-7 rounded-[16px] space-y-2 relative group hover:bg-[#F40E00] hover:text-white transition-all duration-300"
                  key={i}
                >
...
export default WebAppsForBusiness;
