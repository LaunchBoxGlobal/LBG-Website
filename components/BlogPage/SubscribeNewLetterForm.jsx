  ...
  return (
    <div className="w-full rounded-[15px] p-5 lg:p-7 h-[278px] flex flex-col items-center justify-center gap-4 subscribe-email-form">
      ...
      <form
        ...
        className="w-full flex items-center justify-center bg-white rounded-full p-1"
      >
        <input
          type="email"
          name="email"
        ...
        <button
          type="submit"
          disabled={loading}
          className="px-2 whitespace-nowrap bg-[#F40E00] min-w-[120px] h-full text-white text-center rounded-full text-sm font-bold"
        >
          {loading ? (
            <div role="status" className="mx-auto">
              <svg
                aria-hidden="true"
                className="w-5 h-5 text-gray-200 animate-spin fill-black mx-auto"
                viewBox="0 0 100 101"
                fill="none"
