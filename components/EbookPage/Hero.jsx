...
const Hero = () => {
  return (
    <section className="w-full relative pb-20 overflow-x-hidden pt-36 2xl:pt-52 padding-x">
      <div className="w-full relative pt-10 flex flex-col items-center justify-start gap-5 lg:gap-3 bg-white overflow-hidden">
        ...
        <p className="text-base md:text-lg lg:text-[22px] my-2 2xl:text-[26px] font-medium text-gray-500 text-center md:w-2/3 lg:w-[90%] leading-8">
        ...
        <div className="flex flex-col items-center justify-center w-full gap-4 mt-1 ">
          <div className="relative bg-white shadow-xl  p-3 w-[40%] rounded-full" >
            ...
            <button className="bg-[#f40e00] text-white px-6 py-2 rounded-full absolute right-4 top-2" >Subscribe</button>
          </div>
          <span className="text-base flex items-center opacity-85 py-10"><span><FaCheck  className="bg-[#f40e00] rounded-full p-1 text-white mr-3" /></span> It's <span className="text-[#f40e00] mx-1 hover:underline cursor-pointer">100% free</span> and we will never send more than one email per month</span>
        </div>
      </div>
        <div>
